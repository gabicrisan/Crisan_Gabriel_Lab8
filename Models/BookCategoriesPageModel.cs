...
namespace Crisan_Gabriel_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Crisan_Gabriel_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Crisan_Gabriel_Lab8Context context,
